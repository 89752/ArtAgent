...
ArtAgent 是一个面向西方艺术史的对话式 Agent，基于 LangGraph 编排：内置 **53,912 条作品记录、10,107 位画家**的本地艺术库，支持事实查询、风格对比、时间线梳理、偏好推荐、图像分析、文档解读与跨会话长期记忆。
...
合并去重后共 **53,912 条作品记录**、**10,107 位画家**，其中 **39,314 条带描述并已建立 Chroma 向量索引**（BGE-M3 多语言向量）。年代以 8–19 世纪欧洲绘画为主（约占 83%），另含少量 20 世纪早期作品，约 7,000 条未标注年份；每条记录都带图片引用（本地图片或馆藏 URL）。
